...
namespace SnctJikanwari
{
    public class Schedule
    {
        ...
        private static IEnumerable<Schedule> GetSchedules()
        {
            ...
            yield return new Schedule(new DateTime(2020, 10, 16), "後期 履修登録締め切り");
            yield return new Schedule(new DateTime(2020, 10, 18), "ロボコン東北地区大会（オンライン）");
            yield return new Schedule(new DateTime(2020, 10, 23), "地区大会（ラグビー・鶴岡）", enDate: new DateTime(2020, 10, 25));
            yield return new Schedule(new DateTime(2020, 10, 24), "学生健康診断 (1~3年, 4年以上の未受診者対象) 5年 歯科検診");
            yield return new Schedule(new DateTime(2020, 10, 30), "1 授業、2~ 高専体験会準備");
            ...
            yield return new Schedule(new DateTime(2020, 11, 10), fourth: "研修旅行 (中止)", enDate: new DateTime(2020, 11, 13));
            yield return new Schedule(new DateTime(2020, 11, 13), fourth: "キャリアDay");
